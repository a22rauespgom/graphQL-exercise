...
6. **Manejo de Errores:**
   Se manejan los errores que puedan ocurrir durante la mutación para proporcionar una experiencia de usuario más robusta y amigable.# Ejercicio GraphQL + ApolloQL
